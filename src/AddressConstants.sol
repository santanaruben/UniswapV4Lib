...
library AddressConstants {
    ...
    function getOZWAddress(uint256 chainId) internal pure returns (address) {
        if (chainId == 8453) {
            return address(0xdd7257d94d0F269A598FB650d331406de5A46b11); // Base
        }
        if (chainId == 42161) {
            return address(0xB8df119948e3bb1cf2255EBAfc4b9CE35b11CA22); // Arbitrum One
        }
        if (chainId == 421614) {
            return address(0xc6B04026Ad05981840aD6bD77c924c67bAeCf0DC); // Arbitrum Sepolia
        }
